...
--// Fling toggle
createToggle("Fling Toggle", false, function(val)
    hiddenFling = val
    print("Fling Enabled:", val)
end)

--// Fling power slider
createSlider("Fling Power", 1000, 50000, flingPower, function(val)
    flingPower = val
    print("Fling Power:", flingPower)
end)

--// Auto-resize scroll (if using a scroll container)
if uiList and toggleContainer then
        ...
        if hiddenFling then
            ...
            if character then
                ...
                if hrp then
                    ...
                    hrp.Velocity = vel + Vector3.new(0, flingPower, 0)
